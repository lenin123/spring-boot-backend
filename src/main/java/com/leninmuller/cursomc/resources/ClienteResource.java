...
import com.leninmuller.cursomc.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody ClienteNewDTO objDto) {
		Cliente obj = service.findDTO(objDto);
	...
	public ResponseEntity<Page<ClienteDTO>> findPage(
		...
		Page<Cliente> list = service.findPage(page, line, direction, orderBy);
