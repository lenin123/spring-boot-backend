...
import com.leninmuller.cursomc.domain.Pagamento;
import com.leninmuller.cursomc.domain.PagamentoComBoleto;
import com.leninmuller.cursomc.domain.PagamentoComCartao;
...
import com.leninmuller.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateDataBase() throws ParseException {
		...
		Categoria cat5 = new Categoria(null, "Shopping");
		Categoria cat6 = new Categoria(null, "Perfumaria");
		Categoria cat7 = new Categoria(null, "Telefonia");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "leninmullersampaio@gmail.com", "99999999999", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("9999999999, 999999991"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "lenin_muller@uol.com.br", "99999999991", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("9999999999, 999999991"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834",cli1, c1);
		Endereco e2 = new Endereco(null, "Avenidad Matos", "320", "Sala 15", "Centro", "38220865",cli1, c2);
		Endereco e3 = new Endereco(null, "Avenidad Floriano", "2106", "Sala 15", "Centro", "38220865",cli2, c2);
		...
		ped1.getItemsPedido().addAll(Arrays.asList(ip1,ip2));
		ped2.getItemsPedido().addAll(Arrays.asList(ip3));
		
		p1.getItemsPedido().addAll(Arrays.asList(ip1));
		p2.getItemsPedido().addAll(Arrays.asList(ip3));
		p1.getItemsPedido().addAll(Arrays.asList(ip2));	
